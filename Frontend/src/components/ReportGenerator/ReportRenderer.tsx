      ...
      {onDownload && (
        <div className="flex justify-end">
          <button
            ...
            className={`px-5 py-2.5 bg-gradient-to-br from-purple-600 to-purple-800 text-white rounded-lg text-sm font-medium hover:from-purple-700 hover:to-purple-900 transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5 flex items-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed`}
          >
            {isGeneratingPdf ? (
              <>
